                            ...
                            <form action="../action/barang_keluar.php" method="post" class="myform">
                                ...
                                <table class="table table-renponsive">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" name="jumlah" value="" class="form-control" placeholder="" required></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <div class="btn-group">
                        ...
                        <table id="mytable" class="display" width="100%" cellspacing="0">
                            <thead>
                                <tr class="">
                                    ...
                                    <th width="30%" class="text-left">Nama Barang</th>
                                    <th width="10%" class="text-left">Jumlah</th>
...
<div class="modal fade" id="hapus" role="dialog">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <form method="post" action="../action/barang_keluar.php" class="myform">
                <div class="modal-body">
                    <input type="hidden" name="hapus" value="1" readonly>
                    <input type="hidden" name="id_barang_keluar" readonly>
...
<script>
    function ubah(id_barang_keluar, id_bahan_baku, jumlah){
        $('.well input[name=id_barang_keluar]').val(id_barang_keluar);
        $('.well input[name=id_bahan_baku]').val(id_bahan_baku);
        $('.well input[name=jumlah]').val(jumlah);
    }

    function hapus(id_barang_keluar){
        $('.modal-body input[name=id_barang_keluar]').val(id_barang_keluar);
    }
    ...
    $(document).ready(function(){
        ...
        $('#mytable').DataTable({
                    "bProcessing": true,
                    "sAjaxSource": "<?php echo $base_url.'action/tampilkan_data_barang_keluar.php' ?>",
                    "deferRender": true,
                    "select": true,
                    //"dom": 'Bfrtip',
                    //"scrollY": "300",
