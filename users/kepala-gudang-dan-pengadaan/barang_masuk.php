...
<div class="modal fade" id="hapus" role="dialog">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <form method="post" action="../action/barang_masuk.php" class="myform">
                <div class="modal-body">
                    <input type="hidden" name="hapus" value="1" readonly>
                    <input type="hidden" name="id_barang_masuk" readonly>
...
<script>
    function ubah(id_barang_masuk, id_bahan_baku, jumlah){
        $('.well input[name=id_barang_masuk]').val(id_barang_masuk);
        $('.well input[name=id_bahan_baku]').val(id_bahan_baku);
        $('.well input[name=jumlah]').val(jumlah);
    }

    function hapus(id_barang_masuk){
        $('.modal-body input[name=id_barang_masuk]').val(id_barang_masuk);
    }
    ...
    $(document).ready(function(){
        ...
        $('#mytable').DataTable({
                    "bProcessing": true,
                    "sAjaxSource": "<?php echo $base_url.'action/tampilkan_data_barang_masuk.php' ?>",
                    "deferRender": true,
                    "select": true,
                    //"dom": 'Bfrtip',
                    //"scrollY": "300",
