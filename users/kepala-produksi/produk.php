                            ...
                            <form action="../action/produk.php" method="post" class="myform">
                                ...
                                <table class="table table-renponsive">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="nama_produk" value="" class="form-control" placeholder="Misal: Roti Maryam" required></td>
                                    </tr>
                                    <tr>
                                        <td width="15%">Jenis</td>
                                        <td><input type="text" name="jenis_produk" value="" class="form-control" placeholder="Misal: Roti Manis" required></td>
                                    </tr>
                                    <tr>
                                        <td width="15%">Kemasan</td>
                                        <td><input type="text" name="kemasan" value="" class="form-control" placeholder="Misal: Plastik 60g" required></td>
                                    </tr>
                                    <tr>
                        ...
                        <table id="mytable" class="display" width="100%" cellspacing="0">
                            <thead>
                                <tr class="">
                                    ...
                                    <th width="10%" class="text-left">Kemasan</th>
...
<script>
    function ubah(id_produk, nama_produk, jenis_produk, kemasan, harga){
