...
if ($log_user == 'pgw') {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $email      = $data['email'];
        $kata_sandi_baru = "bakery".$username;
        ...
        // More headers
        $headers .= 'From: mars.rizta@gmail.com <noreply@mars.rizta@gmail.com>'."\r\n" . 'Reply-To: '.$username.' <'.$email.'>'."\r\n";
        $headers .= 'Cc: admin@mars.rizta@gmail.com' . "\r\n";
        ...
        if ($kirim) {
            ...
            //reset kata sandi
            $sql = "UPDATE pegawai SET kata_sandi='$kata_sandi' WHERE email='$email'";
